...
const CONTENT: Record<string, React.ReactNode> = {
  ...
  mutuo: (
    <div>
      ...
      <h3>13. Scarica il PDF del prospetto</h3>
      <p>Il pulsante <strong>"Scarica PDF del prospetto"</strong>, sopra i risultati, genera un documento sintetico e diviso in sezioni numerate — sintesi, costo totale dell'operazione, capitale disponibile, quanto mutuo potresti richiedere, detrazioni fiscali (se prima casa) e punti di attenzione — pronto da salvare, stampare o condividere con notaio, banca o un familiare, senza dover tenere aperta l'app.</p>
    </div>
  ),
  finanziamenti: (
    <div>
