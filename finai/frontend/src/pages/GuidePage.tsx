  ...
  mutuo: (
    <div>
      ...
      <ul>
        ...
        <li><strong>Il capitale netto disponibile</strong>: valore di vendita meno spese di agenzia, mutuo residuo ed eventuale imposta sulla plusvalenza — se il risultato è negativo, FINAI te lo segnala chiaramente: la vendita non libererebbe capitale, anzi lascerebbe un debito residuo.</li>
